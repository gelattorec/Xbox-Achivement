            ...
            <div class="animation">
                <div class="circle">
                    ...
                    <div class="img xbox_img">
                        <img src="https://raw.githubusercontent.com/gelattorec/Xbox-Achivement/refs/heads/main/Gelatto%20Logo%20SVG.svg">
                    </div>
...
.brilliant {
  ...
  filter: hue-rotate(167deg) saturate(0.8) brightness(1);
}
...
const achievement = () => {
    ...
    document.querySelector('.unlocked').innerText = rare ? 'Conquista Rara' : 'Achievement unlocked'
    if (rare) {
